...
public interface AslListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link AslParser#func_params}.
	 * @param ctx the parse tree
	 */
	void enterFunc_params(AslParser.Func_paramsContext ctx);
	/**
	 * Exit a parse tree produced by {@link AslParser#func_params}.
	 * @param ctx the parse tree
	 */
	void exitFunc_params(AslParser.Func_paramsContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterDatastrucure_decl(AslParser.Datastrucure_declContext ctx);
	/**
	 * Exit a parse tree produced by {@link AslParser#datastrucure_decl}.
	 * @param ctx the parse tree
	 */
	void exitDatastrucure_decl(AslParser.Datastrucure_declContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterNone(AslParser.NoneContext ctx);
	/**
	 * Exit a parse tree produced by the {@code none}
	 * labeled alternative in {@link AslParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitNone(AslParser.NoneContext ctx);
	/**
