...
define dso_local void @f() {
  ...
  .br.cont.1:
    ...
    %.temp.5 = mul i32 %.temp.4, %.temp.6
    %.temp.8 = trunc i64 3 to i32
    %.temp.7 = add i32 %.temp.5, %.temp.8
    store i32 %.temp.7, i32* %a.addr
    call void @f()
    br label %endif1
  endif1:
    %.temp.10 = trunc i64 9 to i32
    %a.2 = load i32, i32* %a.addr
    %.temp.9 = add i32 %a.2, %.temp.10
    store i32 %.temp.9, i32* %b.addr
    %.temp.13 = trunc i64 2 to i32
    %a.3 = load i32, i32* %a.addr
    %.temp.12 = mul i32 %a.3, %.temp.13
    %b.1 = load i32, i32* %b.addr
    %.temp.11 = add i32 %b.1, %.temp.12
