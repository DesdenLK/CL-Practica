...
define dso_local i32 @main() {
  ...
  .br.cont.1:
    ...
    br label %endif1
  endif1:
    %.temp.5 = trunc i64 4 to i32
    %.temp.7 = trunc i64 5 to i32
    %.temp.6 = mul i32 %.temp.5, %.temp.7
    %.temp.9 = trunc i64 6 to i32
